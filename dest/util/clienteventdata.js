...
export default class ClientEventData {
    ...
    constructor(e, a, b, c) {
        ...
        if (events.API.includes(e)) {
            ...
            this.#channel = a || b;
            if (e == "channelPinsUpdate")
                this.time = b;
        }
        else if (events.DEBUG.includes(e))
            this.info = a;
        else if (events.EMOJI.includes(e)) {
            this.#emoji = a || b;
        }
        else if (events.GUILD_BAN.includes(e))
            this.ban = a;
            ...
            if (events.GUILD_SCHEDULED_EVENT_USER.includes(e))
                this.#user = b;
        }
        else if (events.INTERACTION.includes(e))
            this.interaction = a;
        else if (e == "invalidRequestWarning")
            this.invalidRequestWarningData = a;
        else if (events.INVITE.includes(e))
            this.invite = a;
        else if (events.MESSAGE.includes(e)) {
            if (e == "messageDeleteBulk")
                this.messages = a;
            else
                this.#message = a || b;
        }
    ...
    toJSON() {
        ...
        if (this.stageInstance)
            o.stageInstance = this.stageInstance;
        if (this.partial)
